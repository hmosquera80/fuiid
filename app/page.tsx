        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              ...
              <CardContent className="space-y-3">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Fundación para la Investigación e Inversión en Desarrollo - FUIID
                  </p>
                </div>
                <div>
                  <p className="font-semibold">NIT:</p>
                  <p className="text-sm text-muted-foreground">900.554.517-8</p>
                </div>
                <div>
                  <p className="font-semibold">Registro Cámara de Comercio:</p>
                  <p className="text-sm text-muted-foreground">No. 15.761 - Barranquilla</p>
                </div>
                <div>
                  <p className="font-semibold">Fecha de Constitución:</p>
                  <p className="text-sm text-muted-foreground">13 de Marzo de 2017</p>
                </div>
                <div>
                  <p className="font-semibold">Representante Legal:</p>
                  <p className="text-sm text-muted-foreground">María Eugenia Fadul Mogollón</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <div>
                  <p className="font-semibold">Tipo de Entidad:</p>
                  <p className="text-sm text-muted-foreground">Entidad Sin Ánimo de Lucro (ESAL)</p>
                </div>
                <div>
                  <p className="font-semibold">Grupo NIIF:</p>
                  <p className="text-sm text-muted-foreground">Grupo II</p>
                </div>
                <div>
                  <p className="font-semibold">Código CIIU:</p>
                  <p className="text-sm text-muted-foreground">
                    9499 - Actividades de otras organizaciones asociativas
                  </p>
                </div>
                <div>
                  <p className="font-semibold">Patrimonio:</p>
                  <p className="text-sm text-muted-foreground">$15.800.000</p>
                </div>
                <div>
                  <p className="font-semibold">Último Año Renovado:</p>
              ...
              <CardContent>
                <div className="space-y-4 text-sm text-muted-foreground">
                  <p className="text-pretty leading-relaxed">
                    La Fundación tendrá como objeto social la prestación de servicios y el desarrollo de programas,
                    proyectos y actividades en los ámbitos social, comunitario, educativo, cultural, ambiental, de
                    salud, económico y de desarrollo humano integral, con el fin de contribuir al mejoramiento de la
                    calidad de vida de las personas, familias y comunidades en el orden local, regional, nacional e
                    internacional.
                  </p>

                  <div className="grid md:grid-cols-2 gap-4 mt-6">
                    <div>
                      <h4 className="font-semibold text-foreground mb-2">Áreas de Acción:</h4>
                      <ul className="space-y-1 text-xs">
                        <li>• Desarrollo social e investigación</li>
                        <li>• Promoción en salud y prevención</li>
                        <li>• Fortalecimiento comunitario y étnico</li>
                        <li>• Apoyo a poblaciones vulnerables</li>
                        <li>• Defensa de derechos humanos</li>
                        <li>• Protección y bienestar animal</li>
                      </ul>
                    </div>

                    <div>
                      <h4 className="font-semibold text-foreground mb-2">Servicios Especializados:</h4>
                      <ul className="space-y-1 text-xs">
                        <li>• Asesoría y consultoría profesional</li>
                        <li>• Comedores comunitarios y escolares</li>
                        <li>• Programas de emprendimiento social</li>
                        <li>• Gestión de recursos y donaciones</li>
                        <li>• Participación en licitaciones públicas</li>
                        <li>• Alianzas nacionales e internacionales</li>
                      </ul>
                    </div>
                  </div>

                  <div className="mt-4 p-4 bg-muted/50 rounded-lg">
                    <h4 className="font-semibold text-foreground mb-2">Poblaciones Objetivo:</h4>
                    <p className="text-xs text-pretty">
                      Mujeres cabeza de hogar, familias desplazadas, tercera edad, infancia, juventud, comunidades
                      vulnerables, organizaciones sociales e instituciones públicas y privadas que requieran
                      acompañamiento en procesos de desarrollo integral desde las dimensiones bio-psico-social,
                      económica, cultural, política, ambiental, recreativa y habitacional.
                    </p>
                  </div>
                </div>
              </CardContent>
